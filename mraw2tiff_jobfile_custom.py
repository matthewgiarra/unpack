...
# # #
animal_num = 1;
trial_name = 'mng_2-071-C';
animal_nums.append(animal_num);
trial_names.append(trial_name);

# # #
animal_num = 1;
trial_name = 'mng_2_071-E';
animal_nums.append(animal_num);
trial_names.append(trial_name);
...
# # # #
animal_num = 3;
trial_name = 'mng_2_072_B';
animal_nums.append(animal_num);
trial_names.append(trial_name);

# # # #
animal_num = 3;
trial_name = 'mng_2_072_C';
animal_nums.append(animal_num);
trial_names.append(trial_name);

# # # #
animal_num = 3;
trial_name = 'mng_2_072_D';
animal_nums.append(animal_num);
trial_names.append(trial_name);
...
# # # #
animal_num = 6;
trial_name = 'mng_2-073-F';
animal_nums.append(animal_num);
trial_names.append(trial_name);

# # # #
animal_num = 6;
trial_name = 'mng_2-073-G';
animal_nums.append(animal_num);
trial_names.append(trial_name);
...
# # # #
animal_num = 7;
trial_name = 'mng_2-073-L';
animal_nums.append(animal_num);
trial_names.append(trial_name);

# # # #
animal_num = 7;
trial_name = 'mng_2-073-M';
animal_nums.append(animal_num);
trial_names.append(trial_name);
