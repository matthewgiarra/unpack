...
# Run the python wrapper.
mraw2tiff(data_input_dir = data_input_dir, data_output_dir = data_output_dir, start_image = start_image, exec_path = exec_path, suppress_messages = suppress_messages);
